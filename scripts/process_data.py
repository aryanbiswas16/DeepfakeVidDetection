...
def extract_frames_from_folder(video_folder, output_root, frames_per_video=10):
    """
...
def main():
    ...
    if os.path.exists(ff_real_src):
        extract_frames_from_folder(ff_real_src, ff_real_dst)
    ...
    if ff_fake_root.exists():
        for method_dir in ff_fake_root.iterdir():
            if method_dir.is_dir():
                ...
                extract_frames_from_folder(method_dir, ff_fake_dst)
